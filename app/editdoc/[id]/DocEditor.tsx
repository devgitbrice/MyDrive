...
export default function DocEditor({ allTags: initialAllTags, initialData, prevHref, nextHref, backHref, nextBookDoc, bookSiblings }: DocEditorProps) {
  ...
  return (
    <div className={`flex flex-col h-dvh w-full overflow-hidden transition-[padding] duration-200 ${chatOpen ? "sm:pl-[45vw]" : ""} ${light ? "bg-white text-neutral-900" : "bg-neutral-950 text-white"} ${chromeVisible ? "" : "cursor-none"}`}>
